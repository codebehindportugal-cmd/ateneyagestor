...
class MessagesRelationManager extends RelationManager
{
    ...
    {
        return $form->schema([
            Forms\Components\Textarea::make('body')->label('Resposta')->required()->rows(4),
        ]);
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('authorName')->label('Autor')->state(fn ($record) => $record->authorName()),
