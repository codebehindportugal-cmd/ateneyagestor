        ...
        @forelse($grouped as $year => $months)
            <section>
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-sm text-gray-500 bg-white border border-gray-200 rounded-full px-3 py-1">
                        {{ $yearTotals[$year]['count'] }} doc(s) ·
                        <span class="font-semibold text-gray-700">{{ number_format($yearTotals[$year]['amount'], 2, ',', '.') }} €</span>
                    </span>
                </div>
