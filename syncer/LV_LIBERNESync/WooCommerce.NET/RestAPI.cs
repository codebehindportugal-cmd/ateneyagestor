...
namespace WooCommerceNET
{
    public class RestAPI
    {
        ...
        protected string wc_key = "ck_3bafdbb16adaabccf98fd6d9892bea849b33aa81";
        protected string wc_secret = "cs_14224879df8b3f29800ed2da9e6e571aaed58e92";
       ...
       /* private void product()
        ...
        private async Task<int> exist(Product product)
        {
            RestAPI rest = new RestAPI("http://www.yourstore.co.nz/wp-json/wc/v3/", wc_key, wc_secret);
        ...
        private void createproductf(Product product)
        {
           
            ulong artigoid;
            string desc;

            artigoid = Convert.ToUInt64(product.id);
            desc = product.description;
        }
        private void createproducts(Product product)
        {
            ulong artigoidf;
            string descf;

            artigoidf = Convert.ToUInt64(product.id);
            descf = product.description;
        }
        */
